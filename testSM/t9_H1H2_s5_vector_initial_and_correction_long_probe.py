...
TEST_ID = "H1H2"
TEST_NAME = "s5_vector_initial_and_correction_long_probe"
...
def choose_safe_script_command(true_loc: Dict[str, Any]) -> Dict[str, Any]:
    ...
    distances = [1.00, 0.90, 0.80, 0.70, 0.60, 0.50, 0.40]
    pre_angles = [
        45.0, -45.0,
        60.0, -60.0,
        30.0, -30.0,
...
def run() -> None:
    ...
    print("\nPASS:")
    print(f"{SCANNER} completed H1/H2 S5 vector long-probe test.")
